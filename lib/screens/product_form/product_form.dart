...
Widget sharedAxisTransitionBuilder(Widget child, Animation<double> primaryAnimation, Animation<double> secondaryAnimation) => SharedAxisTransition(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: PageTransitionSwitcher(
        ...
        child: !isSaving.value ? WillPopScope(
          onWillPop: () async {
            if (step.value > 0) {
              step.value--;
              return false;
