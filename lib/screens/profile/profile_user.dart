...
class ProfileUser extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final bool isPrivileged = (authUser != null) && (authUser.role == Role.mod || authUser.role == Role.admin);
    final bool isAuthUserProfile = ModalRoute.of(context).runtimeType != ModalBottomSheetRoute && authUser?.id == user.id;
    final bool isOtherUserProfile = !isAuthUserProfile && authUser?.id != user.id;
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  ConditionalBuilder(
                    condition: (isPrivileged && isOtherUserProfile) || isAuthUserProfile,
                    ifTrue: () => IconButton(
